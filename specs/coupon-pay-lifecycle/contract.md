...
- `specs/order-payment/spec.md`
- `specs/checkout/spec.md`
- `specs/points/spec.md`
- `specs/fulfillment/spec.md`
...
- [ ] B24 [ADDED]: 确认支付 / 支付成功 — verified by BDD test
- [ ] B25 [ADDED]: 确认支付 / 余额不足 — verified by BDD test
- [ ] B26 [ADDED]: 确认支付 / 非待支付状态支付 — verified by BDD test
- [ ] B27 [ADDED]: 确认支付 / 并发与重复支付只成交一次 — verified by BDD test
- [ ] B28 [ADDED]: 确认支付 / 支付他人订单 — verified by BDD test
- [ ] B29 [ADDED]: 支付时限 / 时限随订单生成 — verified by BDD test
- [ ] B30 [ADDED]: 支付时限 / 取消处理前仍可支付 — verified by BDD test
- [ ] B31 [ADDED]: 超时自动取消 / 超时订单被取消 — verified by BDD test
- [ ] B32 [ADDED]: 超时自动取消 / 取消与支付并发只有一方生效 — verified by BDD test
- [ ] B33 [ADDED]: 超时自动取消 / 同一订单重复处理只释放一次 — verified by BDD test
- [ ] B34 [ADDED]: 超时自动取消 / 处理失败不漏单 — verified by BDD test
- [ ] B35 [ADDED]: 超时自动取消 / 取消是终态 — verified by BDD test
- [ ] B36 [ADDED]: 过期券清理任务 / 过期券被置终态 — verified by BDD test
...
### Points changes
- [ ] B52 [MODIFIED]: 余额与流水保持一致 / 任一积分变动 — verified by BDD test
...
### Existing refund behaviors
- [ ] B73 [ADDED]: 驳回仅回退状态 / 驳回成功 — verified by BDD test
- [ ] B74 [ADDED]: 驳回仅回退状态 / 缺少拒绝原因 — verified by BDD test
- [ ] B75 [ADDED]: 驳回仅回退状态 / 重复驳回 — verified by BDD test
- [ ] B76 [ADDED]: 驳回仅回退状态 / 驳回后再次申请 — verified by BDD test
- [ ] B77 [ADDED]: 退款列表查看 / 查看列表 — verified by BDD test
- [ ] B78 [ADDED]: 退款列表查看 / 无查看权限 — verified by BDD test
